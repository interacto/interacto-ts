...
import {WidgetBindingBase} from "../../impl/binding/WidgetBindingBase";
...
export interface BindingsObserver {
     ...
     */
    observeBinding(binding: WidgetBindingBase<Command, Interaction<InteractionData, FSM>, InteractionData>): void;
