...
beforeEach(() => {
    tr = new MouseMoveTransition(new StdState(mock<FSMImpl<FSMDataHandler>>(), "a"), new StdState(mock<FSMImpl<FSMDataHandler>>(), "b"));
...
test("guard OK", () => {
    expect(tr.guard(createMouseEvent("mousemove",
